...
const CheckInOut = () => {
  ...
  const handleCheckIn = async () => {
    try {
      const response = await fetch("https://vms-server-psi.vercel.app/api/visitors/checkin", {
        method: "POST",
        headers: {
  ...
  const handleCheckOut = async () => {
    try {
      const response = await fetch("https://vms-server-psi.vercel.app/api/visitors/checkout", {
        method: "POST",
        headers: {
          "Content-Type": "application/json"
        },
